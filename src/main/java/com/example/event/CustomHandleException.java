...
import com.example.event.exception.room.RoomNotEnabledException;
import com.example.event.exception.roomreservation.NotSuitableForGender;
import com.example.event.exception.sesmester.SesmesterDateValidationException;
import com.example.event.message.ErrorMessage;
